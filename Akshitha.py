...
BACKGROUND_IMAGE_PATH = "C:/Users/sunna/OneDrive/Desktop/memory/shinchanbackground.jpg"  # Update with the path to your background image
...
ANIMATION_SOUND_PATH = "C:/Users/sunna/OneDrive/Desktop/memory/japeneseversion.wav"
CLICK_SOUND_PATH = "C:/Users/sunna/OneDrive/Desktop/memory/cardflipping.wav"
BACKGROUND_MUSIC_PATH = "C:/Users/sunna/OneDrive/Desktop/memory/shinchanbackgroundmusic.mp3"
MATCH_SOUND_PATH = "C:/Users/sunna/OneDrive/Desktop/memory/verygood.wav"  # Sound for matching a pair
WIN_SOUND_PATH = "C:/Users/sunna/OneDrive/Desktop/memory/japeneseversion.wav"  # Sound for winning the game
...
class VideoPlayer(tk.Frame):
    def __init__(self, parent, video_path, speed=1.0):
        ...
        self.video_duration = 14  # Set the video duration to 14 seconds
        ...
        self.update_frame()
        self.after(self.video_duration * 1000, self.stop_animation_sound)  # Stop sound after 14 seconds
    ...
    def update_frame(self):
        ...
        if self.play_count * self.delay >= self.video_duration * 1000:  # Corrected duration check
...
class MemoryGame(tk.Frame):
    ...
    def load_images(self):
        # Load and resize images from 9 to 16
        for i in range(9, 17):
