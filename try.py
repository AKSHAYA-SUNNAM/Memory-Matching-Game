...
import imageio
import os
import pygame  # Added import statement
...
class MemoryMatchingGame:
    def __init__(self, root):
        ...
        self.original_image = Image.open("background_memory.png")  # Make sure this path is correct
        ...
        pygame.init()
        pygame.mixer.init()
        self.background_music = pygame.mixer.Sound("fruitsbackgroundmusic.wav")  # Replace with your music file path
